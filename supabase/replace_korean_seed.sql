-- Replace initial official seed content with Korean MVP content.
-- Intended for the fresh Balance Island Supabase project before real user votes exist.
-- Do not run this later in production without a migration that preserves existing votes.
